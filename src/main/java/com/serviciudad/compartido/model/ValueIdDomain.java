...
public abstract class ValueIdDomain implements Serializable {
    ...
    public ValueIdDomain(String value) {
        this.value = validar(value);
    }

    public ValueIdDomain(String value, int longitudMaxima) {
        this.value = validar(value);
