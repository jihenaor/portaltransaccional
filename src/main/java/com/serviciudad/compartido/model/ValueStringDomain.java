...
public class ValueStringDomain implements Serializable {
    ...
    public ValueStringDomain(String value) {
        this.value = validar(value);
    }

    public ValueStringDomain(String value, int longitudMaxima) {
        this.value = validar(value);
