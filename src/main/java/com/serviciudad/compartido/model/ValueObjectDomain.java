...
public abstract class ValueObjectDomain implements Serializable {
    ...
    public ValueObjectDomain(String value) {
        this.value = validar(value);
    }

    public ValueObjectDomain(String value, int longitudMaxima) {
        this.value = validar(value);
